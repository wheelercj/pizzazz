...
namespace ynot
{
    ...
    /* Changes the terminal window's title.
       ...
       Doesn't work with Windows Terminal. */
    void set_window_title(std::wstring title, std::wostream& wstream = std::wcout, std::ostream& stream = std::cout);
    ...
    void wprint(std::wstring message, std::wostream& wstream = std::wcout, std::ostream& stream = std::cout);
    ...
    /* Prints a message with style such as as color, italics, underline, etc. */
    void print_styled(std::wstring message, std::vector<Style> styles, std::wostream& wstream = std::wcout, std::ostream& stream = std::cout);
    ...
    /* Prints a message with a chosen color.
       ...
       Throws std::invalid_argument if a color value is greater than 255. */
    void print_rgb(unsigned red, unsigned green, unsigned blue, std::wstring message, std::wostream& wstream = std::wcout, std::ostream& stream = std::cout);
    ...
    /* Prints a message with a chosen background color.
       The message can have emoji/Unicode characters.
       Throws std::invalid_argument if a color value is greater than 255. */
    void print_bg_rgb(unsigned red, unsigned green, unsigned blue, std::wstring message, std::wostream& wstream = std::wcout, std::ostream& stream = std::cout);
    ...
    /* Prints a message at chosen coordinates.
       The message can have emoji/Unicode characters. */
    void print_at(unsigned x, unsigned y, std::wstring message, std::wostream& wstream = std::wcout, std::ostream& stream = std::cout);
    ...
    void insert(std::wstring text, std::wostream& wstream = std::wcout, std::ostream& stream = std::cout);
